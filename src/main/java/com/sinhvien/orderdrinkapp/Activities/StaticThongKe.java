...
public class StaticThongKe extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // hiển thị calendar để pick thời gian
    ...
    public void createRandomBarGraph(String Date1, String Date2){
        ...
        try {
            ...
            for(int j = 0; j< dates.size();j++){
                ...
                // x = tổng tiền ngày đó: tong
                //y = ngày đó           :j - vị trí dates
        ...
        // Bar Chart sử dụng 2 list để biểu diễn trục x, trục y
        // trục x: xét giá trị list thời gian
        // trục y: xét các BarDataSet là tập hợp các (barEntry, đơn vị tính)
        // BarEntry là giá trị tổng tiền ngày đó, với vị trí là vị trí dates trong khoảng thời gian xét
    ...
    // lấy danh sách từng ngày trong 1 khoảng ngày
