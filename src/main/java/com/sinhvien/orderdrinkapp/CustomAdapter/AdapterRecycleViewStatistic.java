...
public class AdapterRecycleViewStatistic extends RecyclerView.Adapter<AdapterRecycleViewStatistic.ViewHolder>{
    ...
    Context context;
    int layout;
    List<DonDat> listDonDat;

    public AdapterRecycleViewStatistic(Context context, int layout, List<DonDat> listDonDat){
    ...
    public void onBindViewHolder(AdapterRecycleViewStatistic.ViewHolder holder, int position) {
        ...
        holder.txt_customstatistic_TongTien.setText(donDat.getTongTien() + "");
        ...
        holder.txt_customstatistic_TenNV.setText(donDat.getHoVaTen());
        holder.txt_customstatistic_BanDat.setText(donDat.getTenBan());
    }
